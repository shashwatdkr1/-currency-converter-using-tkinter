...
currencyNameList = ["USD", "INR", "GBP", "CAD", "JPY", "CNY", "INR", 
"AUD", "NZD", "CHF", "SGD", "SEK", "DKK", "NOK", "KRW", "MXN", 
"ZAR", "BRL", "RUB", "TRY", "CZK", "PLN", "PHP", "RON", "HUF", 
"MYR", "IDR", "ILS", "BGN", "HRK", "THB", "ISK", "CLP", "PKR", 
"BHD", "VND", "LKR", "TWD", "SAR", "RSD", "KWD", "JOD", "OMR", 
"QAR", "KZT", "KGS", "UAH", "TMT", "COP", "KES", "LAK", "TJS", 
"UZS", "MNT", "MVR", "NPR", "PYG", "BND", "KHR", "VUV", "FJD", 
"BDT", "KZT", "LBP", "JMD", "LYD", "MAD", "AED", "AFN", "ALL", 
"AMD", "ANG", "AOA", "ARS", "AWG", "AZN", "BAM", "BBD", "BDT", 
"BGN", "BHD", "BIF", "BMD", "BND", "BOB", "BRL", "BSD", "BTN", 
"BWP", "BYN", "BZD", "CDF", "CHF", "CLP", "CNH", "CNY", "COP", 
"CRC", "CUC", "CUP", "CVE", "CZK", "DJF", "DKK", "DOP", "DZD", 
"EGP", "ERN", "ETB", "FJD", "FKP", "GBP", "GEL", "GHS", "GIP", 
...
welcomeLabel = ttk.Label(frame, text="Welcome to Currency 
Converter",background="blue",foreground="white")
